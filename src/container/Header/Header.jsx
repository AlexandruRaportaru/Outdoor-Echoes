    ...
    <>
      <div className='relative header'>
        ...
        <div className='absolute z-30 content'>
          ...
          <p className='font-yanone text-white font-bold'>Pentru a doborî recorduri sau a sparge barierele.<br/> Toată lumea merge pe munte dintr-un alt motiv.<br/> Numai tu îți poți descoperi traseul.</p>
